            ...
            <nav class="navbar navbar-expand-lg " style="padding: 0px !important;">
                <div class="container">
                    ...
                    <form action="search.php" method="POST" enctype="multipart/form-data">
                        <div class="input-group rounded w-100 mt-3 ">
                            <input type="search" class="form-control itemSearch rounded " name="user_query" placeholder="Search" aria-label="Search" aria-describedby="search-addon" />
